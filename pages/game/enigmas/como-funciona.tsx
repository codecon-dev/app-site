        ...
        <Page meta={meta}>
            <Layout hideNav hideFooter>
                <div className="container container-text">
                    ...
                    <h3>Como funciona</h3>
                    <p>
                        Cada andar dá a resposta a um enigma. Para participar, o usuário só precisa
                        ir até o andar desejado, interagir com a Eli (tecla `X`), tentar descobrir
                        qual a resposta para aquele enigma e enviar seu palpite no campo. Eli é um
                        holograma da deusa responsável por criar os nossos enigmas.
                    </p>
                    <p>
                        Para responder os enigmas você deverá fazer login com o seu e-mail da
                        inscrição do Sympla.
                    </p>
                    <p>
