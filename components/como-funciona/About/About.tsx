    ...
    <section className={styles.section}>
      <Grid align="center">
        <Column lg={5} className={styles.content}>
          ...
          <p>
            Uma cidade inteira em 16bits repleta de easter eggs, referências à saga Matrix, estandes
            de patrocinadores, salas de conteúdo e muitas outras surpresas.{' '}
          </p>
          <p>
            Uma experiência incrível onde você nem vai perceber a hora passar e vai se divertir de
            monte.
          </p>
        </Column>
        <Column lg={2} />
