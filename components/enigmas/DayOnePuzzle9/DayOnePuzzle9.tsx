        ...
        <PuzzleLayout bgStyle={styles.bg}>
            {showModal && (
                <div className={styles.modal} onMouseOut={() => setShowModal(false)}>
                    <Image alt="" src="/images/enigmas/9-z.png" width={637} height={545} />
                </div>
            )}
            <div className={styles.image}>
                ...
                {showHover && (
                    <span className={styles.hover} onMouseOut={() => setShowHover(false)}>
                        <Image alt="" src="/images/enigmas/9-h.png" width={98} height={152} />
                    </span>
                )}
                <Image alt="" src="/images/enigmas/9.png" width={738} height={584} />
            </div>
        </PuzzleLayout>
    );
}
