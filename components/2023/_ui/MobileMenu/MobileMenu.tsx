...
function ModalDialog(
    props: Parameters<typeof useOverlay>[0] & Parameters<typeof useDialog>[0] & NavbarProps
) {
    ...
    const allNavigation = [...props.navigation, ...props.secondNavigation];
...
export default function Overlay({ navigation, secondNavigation }: NavbarProps) {
