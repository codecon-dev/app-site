import { CodecodesClaimPayload, CodecodesRankResponse, CodecodesClaimResponse } from "./types";
...
export async function claimCodecodesApiToken({ email, name, code }: CodecodesClaimPayload): Promise<CodecodesClaimResponse> {
  try {
