      ...
      <Grid>
        ...
        <Column lg={3} sm={6}>
          ...
          <div className={styles.social}>
            <a href="https://twitter.com/codecondev" target="_blank" rel="noreferrer noopener">
              <IconTwitter size={24} color="var(--light-green)" />
            </a>
            <a href="https://instagram.com/codecon.dev" target="_blank" rel="noreferrer noopener">
              <InstagramIcon size={24} color="var(--light-green)" />
            </a>
            <a href="https://github.com/codecon-dev" target="_blank" rel="noreferrer noopener">
              <IconGithub size={24} color="var(--light-green)" />
            </a>
            <a href="https://codecon.dev/discord" target="_blank" rel="noreferrer noopener">
